...
docker_build:
	...
	docker build --build-arg PHP_VERSION=8.0-rc -t isocontent:8.0 .
	docker build --build-arg PHP_VERSION=8.0-rc --build-arg COMPOSER_FLAGS="--prefer-lowest" -t isocontent:8.0-lowdeps .
